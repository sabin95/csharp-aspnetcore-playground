...
namespace FermierExpert.Tests.CropFieldsControllerTests
{
    public class UpdateTests
    {
        ...
        {
            var controller = new CropFieldsController(MockDatabaseFactory.Create(), MockQueryHelperFactory.Create());
        ...
        {
            var controller = new CropFieldsController(MockDatabaseFactory.Create(), MockQueryHelperFactory.Create());
            var cropField = new CropFieldCommand { Id = 12, ClientId = 1, CropId = 1 };
